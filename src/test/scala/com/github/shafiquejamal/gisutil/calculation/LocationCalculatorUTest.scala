...
class LocationCalculatorUTest extends FlatSpecLike with Matchers {
  ...
  "GPS coordinates" in {
    ...
    val pointC = GPSCoordinate(Lat(39.11517290061917), Lng(-94.62601276119655))
  
    LocationCalculator
      .intermediatePoint(pointA, pointB, 0.50) shouldEqual GPSCoordinate(Lat(39.11405), Lng(-94.62890723880349))
    LocationCalculator
      .intermediatePoint(pointB, pointC, 0.25) shouldEqual GPSCoordinate(Lat(39.1151729073293), Lng(-94.6281836194018))
  }
  
  "The location calculator" should "calculate the destination point given distance, initial bearing, and starting " +
  "point" in {
    
    val expected = GPSCoordinate(Lat(39.12634533421416), Lng(-94.67103481171077))
    val actual = LocationCalculator.locationFrom(20, GPSCoordinate(Lat(39.11405), Lng(-94.62746000000003)), 4)
