...
class CatchmentCenterUTest extends FlatSpecLike with Matchers {
  ...
  trait Fixture {
    ...
    val expected = Seq(
      ...
      CatchmentCenter("39.11330139958722_-94.62649517413101", GPSCoordinate(Lat(39.11330139958722), Lng(-94.62649517413101)), newEdgeLength),
      CatchmentCenter("39.11405_-94.62842482586905", GPSCoordinate(Lat(39.11405), Lng(-94.62842482586905)), newEdgeLength),
      CatchmentCenter("39.11405_-94.62746000000003", GPSCoordinate(Lat(39.11405), Lng(-94.62746000000003)), newEdgeLength),
      CatchmentCenter("39.11405_-94.62649517413101", GPSCoordinate(Lat(39.11405), Lng(-94.62649517413101)), newEdgeLength),
      CatchmentCenter("39.11479860041278_-94.62842482586905", GPSCoordinate(Lat(39.11479860041278), Lng(-94.62842482586905)), newEdgeLength),
      CatchmentCenter("39.11479860041278_-94.62746000000003", GPSCoordinate(Lat(39.11479860041278), Lng(-94.62746000000003)), newEdgeLength),
      CatchmentCenter("39.11479860041278_-94.62649517413101", GPSCoordinate(Lat(39.11479860041278), Lng(-94.62649517413101)), newEdgeLength))
  }
  ...
  "bounding box and number of slices" in new Fixture {
    val bb = BoundingBox(
      ...
      GPSCoordinate(Lat(39.112927099380826), Lng(-94.62601276119655)), 0.250)
